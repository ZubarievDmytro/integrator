...
import MovingObject from './LocationBasedShipping/MovingObject.jsx';
import Cashdesk from './GlobalComponents/Cashdesk.jsx';
import ShipStation from './LocationBasedShipping/ShipStation.jsx';
...
export default class LocationBasedShipping extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <div className="app location_based_shipping">
