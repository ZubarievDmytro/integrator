...
export default class BankAccount extends React.Component {
    ...
    moveDollarsToCards = () => {
        ...
        dollar1
            ...
            .to(".main_integration .dollar_item_1", this.calcDuration(220, -300, 115, -255), {
                bezier: {
                    values: [{right: 115, top: -255, width: 15}]
                },
                ease: Linear.easeNone
            })
            .to(".main_integration .dollar_item_1", this.calcDuration(115, -255, 20, -185), {
                bezier: {
                    values: [{right: 20, top: -185}]
                },
                ease: Linear.easeNone
            })
            .to(".main_integration .dollar_item_1", this.calcDuration(20, -185, -105, -55), {
                bezier: {
                    values: [{right: -105, top: -55}]
                },
                ease: Linear.easeNone
            })
            .to(".main_integration .dollar_item_1", this.calcDuration(-105, -55, 10, -30), {
                bezier: {
            ...
            .to(".main_integration .dollar_item_1", this.calcDuration(10, -30, 110, 50), {
                bezier: {
        ...
        setTimeout(() => {
            dollar2
                ...
                .to(".main_integration .dollar_item_2", this.calcDuration(220, -300, 115, -255), {
                    bezier: {
                        values: [{right: 115, top: -255, width: 15}]
                    },
                    ease: Linear.easeNone
                })
                .to(".main_integration .dollar_item_2", this.calcDuration(115, -255, 20, -185), {
                    bezier: {
                        values: [{right: 20, top: -185}]
                    },
                    ease: Linear.easeNone
                })
                .to(".main_integration .dollar_item_2", this.calcDuration(20, -185, -105, -55), {
                    bezier: {
                        values: [{right: -105, top: -55}]
                    },
                    ease: Linear.easeNone
                })
                .to(".main_integration .dollar_item_2", this.calcDuration(-105, -55, 10, -30), {
                    bezier: {
                        values: [{right: 10, top: -30, width: 15}]
                    },
                    ease: Linear.easeNone
                })
                .to(".main_integration .dollar_item_2", this.calcDuration(10, -30, 110, 50), {
                    bezier: {
                        values: [{right: 110, top: 50}]
                    },
                    ease: Linear.easeNone
        ...
        setTimeout(() => {
            dollar3
                ...
                .to(".main_integration .dollar_item_3", this.calcDuration(220, -300, 115, -255), {
                    bezier: {
                        values: [{right: 115, top: -255, width: 15}]
                    },
                    ease: Linear.easeNone
                })
                .to(".main_integration .dollar_item_3", this.calcDuration(115, -255, 20, -185), {
                    bezier: {
                        values: [{right: 20, top: -185}]
                    },
                    ease: Linear.easeNone
                })
                .to(".main_integration .dollar_item_3", this.calcDuration(20, -185, -105, -55), {
                    bezier: {
                        values: [{right: -105, top: -55}]
                    },
                    ease: Linear.easeNone
                })
                .to(".main_integration .dollar_item_3", this.calcDuration(-105, -55, 10, -30), {
                    bezier: {
                        values: [{right: 10, top: -30, width: 15}]
                    },
                    ease: Linear.easeNone
                })
                .to(".main_integration .dollar_item_3", this.calcDuration(10, -30, 110, 50), {
                    bezier: {
                        values: [{right: 110, top: 50}]
                    },
                    ease: Linear.easeNone
        ...
        setTimeout(() => {
                dollar4
                    ...
                    .to(".main_integration .dollar_item_4", this.calcDuration(220, -300, 115, -255), {
                        bezier: {
                            values: [{right: 115, top: -255, width: 15}]
                        },
                        ease: Linear.easeNone
                    })
                    .to(".main_integration .dollar_item_4", this.calcDuration(115, -255, 20, -185), {
                        bezier: {
                            values: [{right: 20, top: -185}]
                        },
                        ease: Linear.easeNone
                    })
                    .to(".main_integration .dollar_item_4", this.calcDuration(20, -185, -105, -55), {
                        bezier: {
                            values: [{right: -105, top: -55}]
                        },
                        ease: Linear.easeNone
                    ...
                    .to(".main_integration .dollar_item_4", this.calcDuration(-105, -55, 10, -30), {
                        bezier: {
                            values: [{right: 10, top: -30, width: 15}]
                        },
                        ease: Linear.easeNone
                    })
                    .to(".main_integration .dollar_item_4", this.calcDuration(10, -30, 110, 50), {
                        bezier: {
                            values: [{right: 110, top: 50}]
                        },
                        ease: Linear.easeNone
