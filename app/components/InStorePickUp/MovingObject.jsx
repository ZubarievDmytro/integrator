...
export default class MovingObject extends React.Component {
    ...
    moveObjectToPlatform() {
        $('.in_store_pick_up .moving_object').removeAttr('style');
        TweenMax.set(".in_store_pick_up .moving_object", {left: 1287, top: 680});

        this.tl
            .to(".in_store_pick_up .moving_object", this.calcDuration(1287, 680, 1195, 640), {
                bezier: {
        ...
        this.tl.to(".in_store_pick_up .moving_object", this.calcDuration(1195, 640, 1135, 580), {
            bezier: {
        ...
        this.tl.to(".in_store_pick_up .moving_object", this.calcDuration(1135, 580, 1075, 450), {
            bezier: {
        ...
        this.tl.to(".in_store_pick_up .moving_object", this.calcDuration(1075, 450, 995, 400), {
            bezier: {
        ...
        this.tl.to(".in_store_pick_up .moving_object", this.calcDuration(995, 400, 915, 345), {
            bezier: {
        ...
        this.tl.to(".in_store_pick_up .moving_object", this.calcDuration(860, 380, 835, 290), {
            bezier: {
        ...
        this.tl.to(".in_store_pick_up .moving_object", this.calcDuration(835, 290, 685, 290), {
            bezier: {
        ...
        this.tl.to(".in_store_pick_up .moving_object", this.calcDuration(685, 290, 550, 370), {
            bezier: {
                values: [{left: 550, top: 370}]
            },
            ease: Linear.easeNone
        })
        this.tl.to(".in_store_pick_up .moving_object", this.calcDuration(550, 370, 450, 410), {
            bezier: {
        ...
        this.tl.to(".in_store_pick_up .moving_object", this.calcDuration(450, 410, 365, 400), {
            bezier: {
    ...
    moveObjectToPOS() {
        ...
        TweenMax.set(".in_store_pick_up .moving_object", {left: 450, top: 410, height: 83});
        tl
            .to(".in_store_pick_up .moving_object", 0.6, {
                bezier: {
                    values: [{opacity: 1}]
                },
                ease: Linear.easeNone,
            ...
            .to(".in_store_pick_up .moving_object", this.calcDuration(450, 410, 550, 515), {
                bezier: {
                    values: [{left: 550, top: 515}]
                },
                ease: Linear.easeNone
            })
            .to(".in_store_pick_up .moving_object", this.calcDuration(550, 515, 685, 585), {
                bezier: {
            ...
            .to(".in_store_pick_up .moving_object", this.calcDuration(685, 585, 830, 585), {
                bezier: {
    ...
    moveObjectToPOSFromShop() {
        ...
        TweenMax.set(".in_store_pick_up .moving_object .location", {left: -85, top: 230});
        tl

            .to(".in_store_pick_up .moving_object .location", 0.6, {
                bezier: {
                    values: [{opacity: 1}]
                },
                ease: Linear.easeNone,
            ...
            .to(".in_store_pick_up .moving_object .location", this.calcDuration(-65, 230, -40, 120), {
                bezier: {
                    values: [{left: -40, top: 120}]
                },
                ease: Linear.easeNone
            })
            .to(".in_store_pick_up .moving_object .location", this.calcDuration(-40, 120, 25, 40), {
                bezier: {
                    values: [{left: 25, top: 40}]
                },
                ease: Linear.easeNone,
                onComplete: () => {
                    jQuery('.in_store_pick_up .moving_object.order').css('overflow', 'hidden');
                }
            })
            .to(".in_store_pick_up .moving_object", this.calcDuration(830, 585, 835, 585), {
                bezier: {
            ...
            .to(".in_store_pick_up .moving_object", this.calcDuration(835, 585, 1000, 480), {
                bezier: {
            ...
            .to(".in_store_pick_up .moving_object", this.calcDuration(1000, 480, 1060, 390), {
                bezier: {
                    values: [{left: 1065, top: 390}]
                },
                ease: Linear.easeNone
            })
            .to(".in_store_pick_up .moving_object", this.calcDuration(1065, 390, 1080, 480), {
                bezier: {
